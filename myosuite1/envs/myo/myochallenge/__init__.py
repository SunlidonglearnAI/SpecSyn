...
register_env_with_variants(id='myoChallengeBimanualT2A-v0',
        entry_point='myosuite.envs.myo.myochallenge.bimanual_v0_t2a:BimanualEnvT2A',
        max_episode_steps=1000,
        kwargs={
            'model_path': curr_dir + '/../assets/arm/myoarm_bionic_bimanual.xml',
            'normalize_act': True,
...
register_env_with_variants(id='myoChallengeBimanualT2A1-v0',
        entry_point='myosuite.envs.myo.myochallenge.bimanual_v0_t2a1:BimanualEnvT2A',
        max_episode_steps=1000,
        kwargs={
            'model_path': curr_dir + '/../assets/arm/myoarm_bionic_bimanual.xml',
            'normalize_act': True,
...
register_env_with_variants(id='myoChallengeBimanualT2AV-v0',
        entry_point='myosuite.envs.myo.myochallenge.bimanual_v0_t2av:BimanualEnvT2A',
        max_episode_steps=1000,
        kwargs={
            'model_path': curr_dir + '/../assets/arm/myoarm_bionic_bimanual.xml',
            'normalize_act': True,
...
register_env_with_variants(id='myoChallengeBimanualT2AS-v0',
        entry_point='myosuite.envs.myo.myochallenge.bimanual_v0_t2as:BimanualEnvT2A',
        max_episode_steps=1000,
        kwargs={
            'model_path': curr_dir + '/../assets/arm/myoarm_bionic_bimanual.xml',
            'normalize_act': True,
...
# 注册 T2A 版的 Baoding P1
register(
    id='myoChallengeBaodingP2T2A-v1',
    entry_point='myosuite.envs.myo.myochallenge.baoding_v1_t2a:BaodingEnvT2A', # 指向你的新文件
    max_episode_steps=200,
    kwargs={
        'model_path': curr_dir+'/../assets/hand/myohand_baoding.xml',
        'normalize_act': True,
