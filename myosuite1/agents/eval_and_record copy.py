...
def generate_bio_radar_plot(env, save_path, title_text="T2A Evolution"):
    ...
    labels = ['Force ($F_0$)', ' Velocity ($V_{max}$)', 'Stiffness']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", type=str, default="myoLegWalkT2Apca-v0", help="Environment ID")
    parser.add_argument("--algo", type=str, default="PPO", help="Algorithm (PPO or SAC)")
    parser.add_argument("--model_dir", type=str, default="outputs/2026-03-01/11-48-37", help="Directory containing the .zip model")
