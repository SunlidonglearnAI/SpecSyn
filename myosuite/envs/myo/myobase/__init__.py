...
# ===========================================================
# [T2A Integration] 博士论文实验环境注册
# ===========================================================

register_env_with_variants(
    id="myoLegWalkT2A-v0",  # 新的环境ID
    entry_point="myosuite.envs.myo.myobase.walk_t2a:WalkEnvT2A", # 指向新定义的类
    max_episode_steps=1000,
    kwargs={
...
register_env_with_variants(
    id="myoLegRoughTerrainT2A-v0",
    # 指向我们第一步创建的文件和类
    entry_point="myosuite.envs.myo.myobase.walk_t2a:TerrainEnvT2A", 
    max_episode_steps=1000,
    kwargs={
...
register_env_with_variants(
    id="myoLegHillyTerrainWalkT2A-v0",
    entry_point="myosuite.envs.myo.myobase.walk_t2a:TerrainEnvT2A",
    max_episode_steps=1000,
    kwargs={
        "model_path": curr_dir + leg_model,
...
register_env_with_variants(
    id="myoLegRoughTerrainT2Abi-v0",
    # 指向我们第一步创建的文件和类
    entry_point="myosuite.envs.myo.myobase.walk_t2a_bi:TerrainEnvT2A", 
    max_episode_steps=1000,
    kwargs={
        # 复用原有的 myolegs.xml 模型路径
        "model_path": curr_dir + "/../../../simhive/myo_sim/leg/myolegs.xml",
