...
class T2AWalkMixin:
    ...
    def _setup_t2a(self, **kwargs):
        ...
        # =========================================================
        w_path_local = "synergy_W_basis7.npy"
        w_path_env = os.path.join(os.path.dirname(__file__), "synergy_W_basis7.npy")
        ...
        if os.path.exists(w_path_local):
            ...
            raise FileNotFoundError(f"CRITICAL: 找不到 synergy_W_basis7.npy！\n请确保它在 {os.getcwd()} 或 {os.path.dirname(__file__)} 下。")
