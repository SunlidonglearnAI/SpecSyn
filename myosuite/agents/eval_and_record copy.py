...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", type=str, default="myoLegRoughTerrainT2Apca1-v0", help="Environment ID")
    parser.add_argument("--algo", type=str, default="PPO", help="Algorithm (PPO or SAC)")
    parser.add_argument("--model_dir", type=str, default="outputs/2026-03-28/rough", help="Directory containing the .zip model")
